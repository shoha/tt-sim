...
static func set_own_children(p_owner: Node) -> void:
...
static func _set_owner_recursive(p_owner: Node, p_node: Node) -> void:
...
static func find_child_of_type(parent: Node, type: Variant) -> Node:
...
static func find_children_of_type(parent: Node, type: Variant) -> Array[Node]:
	var result: Array[Node] = []
	_find_children_of_type_recursive(parent, type, result)
	return result


static func _find_children_of_type_recursive(
	node: Node, type: Variant, result: Array[Node]
) -> void:
