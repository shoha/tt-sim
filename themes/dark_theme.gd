...
# Reusable focus style (empty — used for containers/non-interactive controls)
var style_focus_empty: Dictionary:
	get:
		return stylebox_empty({})

# Subtle accent ring for interactive controls (buttons, editors)
var style_focus_ring: Dictionary:
	get:
		return stylebox_flat(
			{
				bg_color = color_transparent,
				border_color = Color(color_accent, 0.4),
				border_ = border_width(2),
				corner_ = corner_radius(corner_r + 1),
				expand_margin_ = expand_margins(2),
			}
		)
...
func _define_checkbox_and_checkbutton():
	...
	define_variant_style(
		"SecondaryCheckBox", "CheckBox", _checkbox_styles(color_secondary, color_secondary_lighter)
	)
	define_variant_style(
		"SuccessCheckBox", "CheckBox", _checkbox_styles(color_success, color_success_lighter)
	)
	define_variant_style(
		"WarningCheckBox", "CheckBox", _checkbox_styles(color_warning, color_warning_lighter)
	)
	define_variant_style(
		"DangerCheckBox", "CheckBox", _checkbox_styles(color_danger, color_danger_lighter)
	)
	...
	define_variant_style(
		"DangerCheckButton", "CheckButton", _checkbutton_styles(color_danger, color_danger_lighter)
	)
...
func _define_menu_button():
	...
	define_variant_style(
		"SuccessMenuButton", "MenuButton", _menu_button_styles(color_success, color_success_lighter)
	)
	define_variant_style(
		"WarningMenuButton", "MenuButton", _menu_button_styles(color_warning, color_warning_lighter)
	)
	define_variant_style(
		"DangerMenuButton", "MenuButton", _menu_button_styles(color_danger, color_danger_lighter)
	)
...
func _define_scrollbars():
	var grabber_normal = inherit(
		style_solid(color_accent),
		{
			border_ = border_width(border_w * 2),
		}
	)
	var grabber_pressed = inherit(
		style_solid(color_accent_darker),
		{
			border_ = border_width(border_w * 2),
		}
	)
	var scroll_track = inherit(
		style_solid(color_background),
		{
