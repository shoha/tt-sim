...
var _base_content_margin: Dictionary:
	get: return {
		content_margin_ = content_margins(margin_w * 2, margin_w * 2),
	}
...
func _define_button():
	...
	var style_hover = inherit(style_normal, {
		bg_color = color_accent_lighter,
		border_color = color_accent_lighter,
	})

	var style_pressed = inherit(style_normal, {
		bg_color = color_accent_darker,
		border_color = color_accent_lighter,
	})
	...
	define_style("Button", {
		...
		focus = style_focus_empty,
		disabled = inherit(style_normal, {
			bg_color = Color(color_accent, 0.5),
...
func _define_checkbox_and_checkbutton():
	# Shared transparent style for both CheckBox and CheckButton
	var style_transparent = style_solid(color_transparent)

	# Shared font colors for toggle controls
	var toggle_font_colors = {
		font_color = color_accent,
		font_hover_color = color_accent_lighter,
		font_pressed_color = color_accent,
		font_hover_pressed_color = color_accent_lighter,
		font_focus_color = color_accent,
		font_disabled_color = color_accent,
	}

	define_style("CheckBox", inherit({
		normal = style_transparent,
		hover = style_transparent,
		pressed = style_transparent,
		hover_pressed = style_transparent,
		checkbox_checked_color = color_accent_lighter,
		checkbox_unchecked_color = color_accent_lighter,
	}, toggle_font_colors))

	define_style("CheckButton", inherit({
		normal = style_transparent,
		hover = style_transparent,
		pressed = style_transparent,
		hover_pressed = style_transparent,
		button_checked_color = color_accent_lighter,
		button_unchecked_color = color_accent_lighter,
	}, toggle_font_colors))
...
func _define_menu_button():
	...
	# MenuButton font colors (accent on accent background)
	var menu_font_colors = {
		font_color = color_accent,
		font_hover_color = color_accent_lighter,
		font_pressed_color = color_accent,
		font_hover_pressed_color = color_accent_lighter,
	...
	define_style("MenuButton", inherit({
		normal = style_normal,
		hover = style_normal,
