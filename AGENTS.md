...
- **New sky preset**: Add to `EnvironmentPresets.SKY_PRESETS` and a matching tile entry to `SkyPane.SKY_TILES` (`scenes/states/playing/visual_panes/sky_pane.gd`), or the Sky pane cannot show or select it
